package com.bootcampeveriskotlin.bootcamppics
...
class MainActivity : AppCompatActivity() {
    ...
    private fun openCamera() {
        ...
        values.put(MediaStore.Images.Media.DESCRIPTION, "Imager capturada pela camera")
        imager_uri = contentResolver.insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == OPEN_CAMERA_CODE){
            image_view.setImageURI(imager_uri)
        }
    }
